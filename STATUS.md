...
| **1: Digital Twin + Briefing Cards** | Week 3-5 | **In progress** | ~~Menu extraction pipeline~~ (5 prospects done, 187 remaining). ~~Structured menu UI in CRM~~. ~~BriefingCard types~~. Pending: baseline interview Andrea Tosi → Digital Twin system prompt → generate briefing cards for top ~47 prospects. |
